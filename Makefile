...
RM = rm -f
RMDIR = rm -rf
INC = -I src -I thirdparty -I thirdparty/raylib-cpp-5.5.0 -I thirdparty/miniz-3.0.2 -I thirdparty/emu2149-1.16
LDFLAGS = -lraylib
...
ifdef CONFIG_W64
    ...
    INC = -I src -I thirdparty -I thirdparty/raylib-cpp-5.5.0 -I /opt/local/raylib-5.5_win64_mingw-w64/include -I thirdparty/miniz-3.0.2
